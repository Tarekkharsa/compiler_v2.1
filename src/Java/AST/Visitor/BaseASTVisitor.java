...
//    }
    ...
    private void printwhileStmt(While_stmt while_stmt) {
        System.out.println("--------------------------------------");
        System.out.println("ast while_stmt");
        if (while_stmt.getK_while() != null) {
            System.out.println(while_stmt.getK_while());
        }
        if (while_stmt.getExpr_while() != null) {
            printExprWhile(while_stmt.getExpr_while());
        }
    ...
    private void printIfStmt(If_stmt if_stmt) {
        ...
        if (if_stmt.getExpr_if() != null) {
            printExprIf(if_stmt.getExpr_if());
        }
